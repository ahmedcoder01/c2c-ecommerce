...
export const signAccessToken = (payload: UpdatedJwtPayload, expiresIn: string | number) =>
  jwt.sign(payload, config.variables.jwtAccessSecret, {
    expiresIn,
  });

export const signRefreshToken = (payload: UpdatedJwtPayload, expiresIn: string | number) =>
